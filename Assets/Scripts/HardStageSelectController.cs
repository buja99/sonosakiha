...
public class HardStageSelectController: MonoBehaviour
{
    [Header("Stage Texts")]
    ...
    public TextAsset[] hardStagePreviewCsvs = new TextAsset[4];
    public int previewFaceSize = 8;
    ...
    void UpdatePreview()
    {
        ...
        if (selectedIndex >= 0 && selectedIndex <= 3)
        {
            if (previewMapGenerator != null)
            {
                ...
                if (hardStagePreviewCsvs[selectedIndex] != null)
                {
                    previewMapGenerator.GeneratePreviewMap(
                        hardStagePreviewCsvs[selectedIndex],
                        previewFaceSize
                    );
                }
            }
