...
public class NormalStageSelectController: MonoBehaviour
{
    [Header("Stage Texts")]
    ...
    public TextAsset[] normalStagePreviewCsvs = new TextAsset[4];
    public int previewFaceSize = 7;
    ...
    void UpdatePreview()
    {
        ...
        if (selectedIndex >= 0 && selectedIndex <= 3)
        {
            if (previewMapGenerator != null)
            {
                ...
                if (normalStagePreviewCsvs[selectedIndex] != null)
                {
                    previewMapGenerator.GeneratePreviewMap(
                        normalStagePreviewCsvs[selectedIndex],
                        previewFaceSize
                    );
                }
            }
